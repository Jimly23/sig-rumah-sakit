            ...
            <div class="bg-surface border border-outline-variant rounded-xl overflow-hidden shadow-sm p-6 mb-6">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="url" name="link_gmaps" id="link_gmaps" value="<?= htmlspecialchars($hospital['link_gmaps'] ?? '') ?>" class="w-full px-4 py-3 bg-surface-container-lowest rounded-xl border border-outline-variant focus:ring-2 focus:ring-primary text-sm" placeholder="https://www.google.com/maps/embed?pb=...">
    ...
    <!-- <div class="lg:col-span-1 space-y-6">
        <div class="bg-white rounded-2xl border border-outline-variant p-6 shadow-sm sticky top-24">
            ...
            <?php if (!empty($hospital['link_gmaps'])): ?>
                <div id="gmaps-preview" class="w-full aspect-square rounded-xl border border-outline-variant z-0 mb-4 overflow-hidden">
                    <iframe id="gmaps-iframe" src="<?= htmlspecialchars($hospital['link_gmaps']) ?>" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            <?php else: ?>
