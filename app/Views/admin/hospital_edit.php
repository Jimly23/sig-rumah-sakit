            ...
            <div class="bg-surface border border-outline-variant rounded-xl overflow-hidden shadow-sm p-6 mb-6">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="link_gmaps" id="link_gmaps" value="<?= htmlspecialchars($hospital['link_gmaps'] ?? '') ?>" class="w-full px-4 py-3 bg-surface-container-lowest rounded-xl border border-outline-variant focus:ring-2 focus:ring-primary text-sm" placeholder="https://www.google.com/maps/embed?pb=...">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="latitude" id="latitude" value="<?= $hospital['latitude'] ?>" class="w-full px-4 py-3 bg-surface-container rounded-xl border-none focus:ring-2 focus:ring-primary text-sm font-mono" required readonly>
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-on-surface mb-2">Longitude <span class="text-error">*</span></label>
                            <input type="text" name="longitude" id="longitude" value="<?= $hospital['longitude'] ?>" class="w-full px-4 py-3 bg-surface-container rounded-xl border-none focus:ring-2 focus:ring-primary text-sm font-mono" required readonly>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="whatsapp" value="<?= htmlspecialchars($hospital['whatsapp']) ?>" class="w-full px-4 py-3 bg-surface-container-lowest rounded-xl border border-outline-variant focus:ring-2 focus:ring-primary text-sm">
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
